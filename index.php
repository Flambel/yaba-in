...
?>
	...
	<div class="converter">
		<div class="converter_background parallax-window" data-parallax="scroll" data-image-src="images/yabain_team.jpeg" data-speed="0.3"></div>
				...
				<div class="col">
					...
					<div class="services_slider_container">
						<div class="owl-carousel owl-theme services_slider">
							...
							<!-- Services Item -->
							<div class="owl-item">
								<div class="services_item1 d-flex flex-column align-items-center justify-content-center">
							...
							<!-- Services Item -->
							<div class="owl-item">
								<div class="services_item2 d-flex flex-column align-items-center justify-content-center">
									<div class="services_item_bg"></div>
									<div class="services_icon"></div>
									<div class="services_icon"></div>
							...
							<!-- Services Item -->
							<div class="owl-item">
								<div class="services_item3 d-flex flex-column align-items-center justify-content-center">
									<div class="services_item_bg"></div>
									<div class="services_icon"></div>
									<div class="services_icon"></div>
							...
							<!-- Services Item -->
							<div class="owl-item">
								<div class="services_item4 d-flex flex-column align-items-center justify-content-center">
									<div class="services_item_bg"></div>
									<div class="services_icon"></div>
									<div class="services_icon"></div>
					...
					<div class="footer_newsletter">
						...
						<div class="footer_social">
							<ul>
								...
								<li><a target="_blank" href="https://www.github.com"><i class="fa fa-github" aria-hidden="true"></i></li>
								<li><a target="_blank" href="https://www.youtube.com"><i class="fa fa-youtube" aria-hidden="true"></i></li>
								<li><a target="_blank" href="https://www.linkedin.com"><i class="fa fa-linkedin" aria-hidden="true"></i></li>
								<li><a target="_blank" href="https://www.twitter.com"><i class="fa fa-twitter" aria-hidden="true"></i></li>
							</ul>
						</div>
					</div>
				</div>
